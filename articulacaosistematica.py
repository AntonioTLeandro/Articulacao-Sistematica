...
def parametrosEscalas(escala):
    ...
    if escala == '1:1.000':
        ...
        paramentos.append(5.20833333333333E-03) #DimenLat
        paramentos.append(5.20833333333333E-03) #DimenLong
        paramentos.append(2) #DivMenorLat
        paramentos.append(2) #DivMenorLong
    elif escala == '1:2.000':
        paramentos.append(2000)
        paramentos.append(1.04166666666667E-02)
        paramentos.append(1.04166666666667E-02)
        paramentos.append(2)
        paramentos.append(3) 
    elif escala == '1:5.000':
        paramentos.append(5000)
        paramentos.append(2.08333333333333E-02)
        paramentos.append(0.03125)
        paramentos.append(2)
        paramentos.append(2)
    elif escala == '1:10.000':
        paramentos.append(10000)
        paramentos.append(4.16666666666667E-02)
...
def gerarfolhas(coord, sRs):
    ...
    for j in range(int(lQVLat)):
        ...
        NumRef = LRefla / L1mil
        LRefla = NumRef * L1mil
        sVert.append(QgsPointXY(LReflo, LRefla))
        j += 1
    j = 1    
